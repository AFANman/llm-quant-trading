"""I: 冷却0天, 上涨底仓2万, 跌>3%加仓, 1×ATR卖出, [25k,15k,10k,5k] 4次加仓"""
import pandas as pd, numpy as np, sys
sys.path.insert(0, '/Users/fanzhangmu/llm_trading_lab')
from data_fetcher import fetch_stock_data
from backtest_engine import compute_indicators

def run(df, init_cash=100000, base_pos=20000, max_add=4, adds=[25000,15000,10000,5000], cooldown=0, dip_thr=-0.03, bounce_mult=1.0):
...
print("I: 冷却0天 | 底仓2万 | 跌>3%加仓 | 1×ATR卖 | [25k,15k,10k,5k] 4次加仓")
print("="*80)
alphas=[]; mdds=[]; tcs=[]
